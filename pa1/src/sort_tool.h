...
class SortTool {
    public:
        ...
        static void        InsertionSort(vector<int>&); // sort data using insertion sort
    ...
    private:
        void        QuickSortSubVector(vector<int>&, int, int, const int, mt19937&); // quick sort subvector
        static int         RandomizedPartition(vector<int>&, int, int, mt19937&); // randomized partition the subvector
        static int         Partition(vector<int>&, int, int); // partition the subvector
        void        MergeSortSubVector(vector<int>&, int, int); // merge sort subvector
        static void        Merge(vector<int>&, int, int, int); // merge two sorted subvector
